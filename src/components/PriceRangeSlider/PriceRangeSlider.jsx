...
const PriceRangeSlider = ({ ...props }) => {
  ...
  const handlePriceChange = (value) => {
    ...
    props.updateFilterData({ priceRange: value });
  };
  ...
  return (
    <>
      <div className="relative mb-6">
        ...
        <span className="text-sm absolute start-2/4 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6 text-secondary-blue">{`AED ${priceRange[0]} to ${priceRange[1]}`}</span>
